...
%>	
	...
	<div id='body'>
		...
		<form action='justOrderProc.jsp' method='post'>
...
<%
	...
	String Cnt = request.getParameter("orderCnt");
	int orderCnt = Integer.parseInt(Cnt); //주문수량
	session.setAttribute("orderCnt", orderCnt);
	
	Long ISBN =Long.parseLong(request.getParameter("cartBook")); //ISBN값	
	
	Book book = bookService.findBook(ISBN);	//구매한 책
	session.setAttribute("cartBook", book);
%>
		         <tr style='text-align:center; padding:10px 0px;'>
		            ...
		            <td style='text-align:left'>
		               <ul class='list-unstyled' id='info'>
		                  ...
		                  <li><small style='color:#777777'>수량 : <%=session.getAttribute("orderCnt")%>개</small></li>
			...
			<table class='deli_table'>
				<tbody style='vertical-align: middle'>
					<tr>
						...
						<td><%=book.getBookPrice() * orderCnt %> 원</td>
					</tr>
					<tr>
