...
<%
	...
	Book book = (Book)session.getAttribute("cartBook"); //주문한 책
	
	
	int orderCnt = Integer.parseInt(session.getAttribute("orderCnt").toString()); //주문수량
	...
	if(orderPay != null){
		...
		//System.out.println(order.getDeliveryNum());
%>
		<c:redirect url='justOrderComplete.jsp'/>		
<%
	}else{
%>
