...
<%
	...
	String c = request.getParameter("msg5");
	if(c == null) c = "";
%>
<!DOCTYPE html>
<html lang="ko">
	...
	<div class='sign'>
		<form action="correctProc.jsp">
			<table class='sign'>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="#content2" data-toggle="collapse" style="display: block;">비밀번호 수정</a><%= c %>
									</h4>
								</div>
								<div id="content2" class="collapse panel-collapse">
									<ul class="list-group">
										<li class="list-group-item">▶새 비밀번호&nbsp;<input type='password' class="form-control" name="newPwd1" value="<%= user.getUserPwd() %>"/></li>
										<li class="list-group-item">▶새 비밀번호 확인&nbsp;<input type='password' class="form-control" name="newPwd2" value="<%= user.getUserPwd() %>"/></li>
									</ul>
								</div>
							</div>
						</div>		
				...
				<tr class='number'>
					<th>휴대폰 번호</th>
					<td><input type='text' name="newPhoneNum"  value="<%= user.getPhoneNum() %>"
